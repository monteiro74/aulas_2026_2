...
- [:date: 4. Datas de avaliações](#date-4-datas-de-avaliações)
- [:hammer\_and\_wrench: 5. Ferramentas](#hammer_and_wrench-5-ferramentas)
- [:books: 6. Livros (básicos)](#books-6-livros-básicos)
- [:newspaper: 7. Artigos (referências bibliográficas complementares)](#newspaper-7-artigos-referências-bibliográficas-complementares)
  - [:books: 7.1. Outras referências complementares](#books-71-outras-referências-complementares)
- [:notebook: 8. Cursos gratuítos (opcionais)](#notebook-8-cursos-gratuítos-opcionais)
  - [:notebook: 8.1. Cursos sobre BI com Scriptcase](#notebook-81-cursos-sobre-bi-com-scriptcase)
- [:green\_book: 9. Como estudar (dicas)](#green_book-9-como-estudar-dicas)
- [:family\_man\_woman\_girl\_boy:  11. Grupos no telegram](#family_man_woman_girl_boy--11-grupos-no-telegram)
- [:tv: 10. Videos recomendados (material opcional)](#tv-10-videos-recomendados-material-opcional)
- [:office: 11. Projetos da fundação Apache e suas características](#office-11-projetos-da-fundação-apache-e-suas-características)
- [:alarm\_clock: 12. Carga horária de 15hs adicionais (remota/online)](#alarm_clock-12-carga-horária-de-15hs-adicionais-remotaonline)
  - [🎓 12.1. Playlist de Introdução à Engenharia de Dados (até 15h)](#-121-playlist-de-introdução-à-engenharia-de-dados-até-15h)
  - [📺 12.2. Playlist: Fundamentos de Engenharia de Dados (14h)](#-122-playlist-fundamentos-de-engenharia-de-dados-14h)
    - [🎓 12.2.1 Introdução à Engenharia de Dados](#-1221-introdução-à-engenharia-de-dados)
    - [🧩 12.2.2. Modelagem de Dados](#-1222-modelagem-de-dados)
    - [🔄 12.2.3. ETL (Extract, Transform, Load)](#-1223-etl-extract-transform-load)
    - [🏢 12.2.4. Data Warehouse](#-1224-data-warehouse)
    - [🌊 12.2.5. Data Lake](#-1225-data-lake)
    - [🧪 12.2.6. Pipelines de Dados](#-1226-pipelines-de-dados)
    - [🔐 12.2.7. Governança de Dados](#-1227-governança-de-dados)
    - [📊 12.2.8. Big Data](#-1228-big-data)
  - [📄 12.3. Artigos Científicos Open Access sobre Engenharia de Dados](#-123-artigos-científicos-open-access-sobre-engenharia-de-dados)
- [📄 13. Exemplos usados em sala de aula](#-13-exemplos-usados-em-sala-de-aula)
- [📄 14. Assuntos diversos](#-14-assuntos-diversos)
  - [14.1. Vagas de emprego para "Engenheiro de dados":](#141-vagas-de-emprego-para-engenheiro-de-dados)
  - [14.2. Pesquisa Salarial:](#142-pesquisa-salarial)
...
| 10  |  | 3hs  | **Avaliação 2.** |
| 11  |  | 3hs  | Exercício com docker (Metabase, Grafana e Superset). |
| 12  |  | 3hs  | Regressão linear, Arquivo .RIS, Qualidade de dados. Exercício com streamlit. |
| 13  |  | 3hs  | Datastream Apache + kafka, Infra para ETL, Kibana, Opentelemetry, Exemplo de caso de conversão de dados. GitHub Contributions Chart Generator. |
| 14  |  | 3hs  | Governança, openRefine, Tendências de engenharia de dados. |
| 15  |  | 3hs  | **Avaliação 3.** |
