...
| -- | --------------------------------------------- | --------- | ---- | ---------- | ---------- | ---------- |
| 1  | ALEX PABLO DE OLIVEIRA MORAES                 |Joao Ricardo | Desenvolvimento de uma Plataforma Web para Automação da Gestão de Documentos em Escritórios de Contabilidade Utilizando IA Generativa     |  ✅           |            |            |
...
| 8  | EMANUEL ESTEVAM DE OLIVEIRA DUTRA             |Ivan       | Desenvolvimento do Frontend de uma Plataforma Digital Colaborativa para Gestão Sustentável de Resíduos da Construção Civil    |  ✅           |            |            |
...
| 24 | PEDRO SALVADOR DE ARAUJO                      |Juliano           | Gestão de contratos de locação     | ⚠️   |            |            |
