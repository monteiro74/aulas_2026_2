...
| 4   |  | 3hs          | Instalação de VM. Logs. Trilhas de auditoria. Bloqueio e impasse. Intro. Modelo ER. Conceitos de threads, Conceitos de segurança, Exercício com SQL Server importação de tabela excel, Modelo de dados, Revisão de SQL com MySQL. |
| 5   |  | 3hs          | Avaliação 1. |
