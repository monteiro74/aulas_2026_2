...
* FACET-SNP-323 - MODELAGEM E PROJETO DE BANCO DE DADOS - T01 (2026.2 - 5N123)
...
- [20. Modelagem de OLTP para OLAP](#20-modelagem-de-oltp-para-olap)
  ...
  - [Exercícios com o SQL Server](#exercícios-com-o-sql-server)
...
|-----|--------|--------------|----------|
| 1   |  | 3hs          | Apresentação da disciplina. Conceitos iniciais necessários da disciplina. conceitos básicos sobre bancos de dados, referências bibliográficas. Ranking de bancos de dados. Conceitos, conceitos de banco de dados, comparações entre sistemas gerenciadores de bancos de dados e sistemas operacionais. conceitos de serviços. Comentários sobre as referências bibliográficas. <br> Exercício: 1) Baixar o SQL Server Express. 2) Baixar o SSMS (SQL Server Management Studio). 3) Instalar ambas as ferramentas.<br> [Slides da aula1, parte 1](https://docs.google.com/presentation/d/1CkAY74f9UYWJgfSnPycpU_9oC5vF1KqZXeNo87SBIPY/edit?usp=view); [Slides de aula2, parte 2](https://docs.google.com/presentation/d/1aRyd7szh_eD5KXaXrWqn6W6HHQtqHJtNEQIpSTVnya8/edit?usp=view); [Slides das referências](https://docs.google.com/presentation/d/1qqgo3p-C7MYWPKAonTNRsKzx2TxR9n257LZfQnyp900/edit?usp=view); [Ranking de banco de dados](https://db-engines.com/en/ranking) <br> |
| 2   |  | 3hs          | Aula 2: Tipos de usuários, papéis do admin de banco, níveis da arquitetura, arquitetura, estrutura do mysql e sql server, armazenamento, buffering, tipos de registro, operações em arquivos,  tipos de acesso, estrutura de índices, processamento de consultas, componentes de um custo de execução de consultas; [Slides de aulas](https://docs.google.com/presentation/d/1SKLSNZh9DNdRlvnOgS6Q-DV5n3RKekW2r9A0X4Pag9s/edit?usp=view); [Slides sobre a instalação do SQL Server](https://docs.google.com/presentation/d/1A-BC_44w3bttr_eJpP2LZWXGjoGj0MzxpYW3yZ0EWDQ/edit?usp=view).<br> |
| 3   |  | 3hs          | Detalhes do SQL Server. [Slides de aulas](https://docs.google.com/presentation/d/1hwlcEoWe0Fj1TZpsdZWaZMwoy1NT-lEcYqOjoGUK_eU/edit?usp=view), [Conhecendo o SSMS](https://docs.google.com/presentation/d/1HIyXxcm9p643aD5sdmBTvc-Rs9UVa-LPdLsLmzzE2us/edit?usp=view), [SSMS visão geral dos objetos](https://docs.google.com/presentation/d/1MbYS4Vx7oJPMJ_O2bfWrSWrYMcMKModOrpIMkV3JDZs/edit?usp=view), [Script para o SQL Server](https://docs.google.com/document/d/1RCd6EjXHtBcCGAo0zJdxZr-Zx37JsEhOeFuxipulXIk/edit?usp=view).<br> |
https://raw.githubusercontent.com/monteiro74/aulas_2026_1/refs/heads/main/figuras/mapa_mental_conceitos_nosql.png),<br> [Mapa mental de "TECNOLOGIAS" NoSQL](https://raw.githubusercontent.com/monteiro74/aulas_2026_1/refs/heads/main/figuras/mapa_mental_tecnologias_nosql.png), <br> [Infográfico de tecnologias NoSQL](https://raw.githubusercontent.com/monteiro74/aulas_2026_1/refs/heads/main/figuras/infografico_Bancos_NoSQL.png). <br> Vídeo: <br> [Redis vs MySQL](https://www.youtube.com/watch?v=iiHvAo61H-w),<br> [O artigo citado no video](https://shopify.engineering/scaling-inventory-reservations),<br> [Infográfico escalando banco de dados](https://raw.githubusercontent.com/monteiro74/aulas_2026_1/refs/heads/main/figuras/Infografico_Escalando_bdados_relacionais.png),<br> [Infográfico sobre as tecnologias comentadas no vídeo](https://raw.githubusercontent.com/monteiro74/aulas_2026_1/refs/heads/main/figuras/Infografico_otimiza%C3%A7%C3%A3o_de_Arq_de_Dados.png) |
|15   |  | 3hs          |Avaliação 3. |
...
---
### Exercícios com o SQL Server


-- ============================ <br>
-- 1) CRIAÇÃO DO BANCO DE DADOS <br>
-- ============================ <br>
```SQL
...
-- =================================== <br>
-- 3) INSERINDO DADOS NA TABELA ALUNOS <br> 
-- =================================== <br> 
```SQL
...
-- ===================================== <br>
-- 4) TABELA SITUAÇÃO (STATUS DO ALUNO) <br>
-- ===================================== <br>
...
-- ================================= <br> 
-- 8) RELACIONAMENTOS (FOREIGN KEYS) <br>
-- ================================= <br>
```SQL
...
-- ============================================== <br>
-- 10) TABELA PETS (EXERCÍCIO DE RELACIONAMENTO) <br>
-- ============================================== <br> 
```SQL
...
-- =================================== <br>
-- 11) CONSULTAS COM JOIN E CÁLCULOS <br>
-- ================================== <br>
```SQL
...
-- ================================= <br> 
-- 12) AGRUPAMENTO, HAVING E ORDER <br>
-- ================================ <br>
```SQL
...
-- ================================ <br>
-- 13) FUNÇÕES NUMÉRICAS E DE DATA <br>
-- =============================== <br>
```SQL
...
-- ======================================================= <br> 
-- 15) USUÁRIO/ROLE EXCLUSIVO PARA BACKUP DO BANCO "cafe" <br> 
-- ======================================================= <br>
-- Observação: <br>
--  - Para gravar o arquivo .BAK, a conta do serviço do SQL Server<br>
--    precisa ter permissão NTFS na pasta de destino.<br>
```SQL
USE master;
GO
...
-- =================================================== <br>
-- 16) TAMANHO DO BANCO "cafe" (por arquivo e total) <br>
-- =================================================== <br>
```SQL
USE master;
GO
...
-- ======================================================= <br>
-- 17) TABELAS, COLUNAS E TIPOS DE DADOS (BANCO "cafe") <br>
-- ======================================================= <br>
```SQL
USE cafe;
GO
...
-- ======================================================= <br>
-- 18) RECURSOS: CPU, MEMÓRIA E DISCO (versões globais e "safe") <br>
-- ======================================================= <br>
```SQL
...
Fim dos exercícios com SQL Server.
