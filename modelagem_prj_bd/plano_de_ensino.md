...
|-----|--------|--------------|----------|
| 1   |  | 3hs          | Apresentação da disciplina. Conceitos iniciais necessários da disciplina. conceitos básicos sobre bancos de dados, referências bibliográficas. Ranking de bancos de dados. Conceitos, conceitos de banco de dados, comparações entre sistemas gerenciadores de bancos de dados e sistemas operacionais. conceitos de serviços. Comentários sobre as referências bibliográficas. [Slides 1](https://docs.google.com/presentation/d/1X_IwphY5nnoxvApFkEFPqE5is8oE9fhtkxJ0EDv_GXI/edit?usp=view), [Slides 2](https://docs.google.com/presentation/d/1KlhkrH61phTjanzWlYAvIkb7-QMWghHYBDLUfFKzu5M/edit?usp=view), [Referências bibliográficas](https://docs.google.com/presentation/d/15l0FeQ0RysIUgVXv8eqDIigFDxDDzWNj5pX72J8FBQI/edit?usp=view). <br> Exercício: 1) Baixar o SQL Server Express. 2) Baixar o SSMS (SQL Server Management Studio). 3) Instalar ambas as ferramentas. <br> |
| 2   |  | 3hs          | Aula 2: Tipos de usuários, papéis do admin de banco, níveis da arquitetura, arquitetura, estrutura do mysql e sql server, armazenamento, buffering, tipos de registro, operações em arquivos,  tipos de acesso, estrutura de índices, processamento de consultas, componentes de um custo de execução de consultas; [Slides de instalação de sql server](https://docs.google.com/presentation/d/18stwaeg5eErdR9MNMtk3I4Rn-crw457oWiN_LdI2wW4/edit?usp=view) .<br> |
| 3   |  | 3hs          | Detalhes do SQL Server. Slides de aulas, Conhecendo o SSMS, SSMS visão geral dos objetos, Script para o SQL Server. [Conceitos de threads](https://docs.google.com/presentation/d/1fCicd5husqYCSdAVSgpr7CxEfC2i2gfft_vSy4TbjyM/edit?usp=view), [Conceitos de segurança](https://docs.google.com/presentation/d/1fCicd5husqYCSdAVSgpr7CxEfC2i2gfft_vSy4TbjyM/edit?usp=view), [Modelo global e normalização](https://docs.google.com/presentation/d/1jL_UQ3QUcephGVwEqJC6-0ZTeFcWpATRfXPBra1yRQM/edit?usp=view), [Conhecendo o SSMS](https://docs.google.com/presentation/d/1-opQfueYlLv361SJhoSe3uVT_uFrEkaD1hDIeAXN0uw/edit?usp=view). <br> |
| 4   |  | 3hs          | [Modelagem ER](https://docs.google.com/presentation/d/14oKDhJzNe3o3PXY_WGD0A9AzPgmQx8Y0oJ56sI_O0s8/edit?usp=view), [Exercício modelagem mineradora](https://docs.google.com/presentation/d/1EDW14Z30rHzJgicDrM4OWKcSUCEVZOnB-arJHIgcTeA/edit?usp=view), [ODBC](https://docs.google.com/presentation/d/1NhA4NGAlEPFFKYRLN5Hk7nAMvNL5IKnuZvzMVfaMUpc/edit?usp=view), [Conhecendo partes do SSMS](https://docs.google.com/presentation/d/1gFVmOGmgOFJZjC7rK6yJ5-66-palnwlt5v3z1DcM-r4/edit?usp=view). |
| 5   |  | 3hs          | Avaliação 1. |
| 6   |  | 3hs          | Conhecendo o SSMS (sql server management studio). Monitorando o SQL Server e propriedades do servidor. Aula6 ODBC, PostgreSQL, Revisão modelo ER, SQL Server criptografia, SQL Server Mail, SQL Server Migration Assistant, SQL Server Monitoracao, SQL Server Profiler. |
| 7   |  | 3hs          | Exercício 1, Exercício 2. |
| 8   |  | 3hs          | Joins no SQL Server. PostgreSQL.  SQL Join, PostgreSQL. |
| 9   |  | 3hs          | Blockchain, Multichain, Exemplo com Multichain. |
|10   |  | 3hs          | Avaliação 2. |
|11   |  | 3hs          | Blockchain, Hyperledger, Multichain. |
|12   |  | 3hs          | Sistema distribuído, Certificado digital. |
|13   |  | 3hs          | Bancos NoSQL, Banco MS Access, OLTP x OLAP, Ecosistema NoSQL, Mapa mental do NoSQL. Rodar IA Local. |
...
* Avaliação 1: 10/09/2026.
* Avaliação 2: 15/10/2026.
* Avaliação 3: 19/11/2026.
